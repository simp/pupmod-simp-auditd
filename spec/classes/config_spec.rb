    ...
    on_supported_os.each do |os, os_facts|
      context "on #{os}" do
        ...
        context 'with default parameters' do
          ...
          # managing their mode fights augenrules and breaks idempotency, so
          # the mode is intentionally left unmanaged
          it { is_expected.to contain_file('/etc/audit/audit.rules').without_mode }
          it { is_expected.to contain_file('/etc/audit/audit.rules.prev').without_mode }
